    ...
    <div className={`${styles.ml}`}>
      ...
      <div>
        ...
        <p>
          ...
          propriété de <strong>Les Ciseaux d'Antoine</strong>. Toute
          reproduction, représentation ou utilisation est interdite sans
      ...
      <div>
        ...
        <p>
          ...
          d'autres sites internet. <strong>Les Ciseaux d'Antoine</strong> ne
          peut être tenu responsable du contenu de ces sites externes.
        </p>
        <br />
      </div>
      <div>
